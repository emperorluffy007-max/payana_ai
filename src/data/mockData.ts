...
export const stops: BusStop[] = [
  ...
  { id: "s5", name: "Hebbal", lat: 13.0358, lng: 77.597 },
  { id: "s6", name: "Koramangala", lat: 12.9352, lng: 77.6245 },
  { id: "s7", name: "Silk Board", lat: 12.9173, lng: 77.623 },
  { id: "s8", name: "Electronic City", lat: 12.8456, lng: 77.6603 },
  { id: "s9", name: "Whitefield", lat: 12.9698, lng: 77.75 },
  { id: "s10", name: "Jayanagar", lat: 12.9308, lng: 77.5838 },
  { id: "s11", name: "Malleshwaram", lat: 13.0031, lng: 77.5643 },
  { id: "s12", name: "Yelahanka", lat: 13.1007, lng: 77.5963 },
  { id: "s13", name: "Banashankari", lat: 12.9255, lng: 77.5468 },
  { id: "s14", name: "Marathahalli", lat: 12.9569, lng: 77.7011 },
  { id: "s15", name: "BTM Layout", lat: 12.9166, lng: 77.6101 },
];
...
export const initialBuses: Bus[] = [
  ...
  },
  {
    id: "BUS-252F",
    route: "252-F",
    routeName: "Majestic → Malleshwaram",
    lat: 12.985,
    lng: 77.568,
    eta: 6,
    delay: 1,
    ...
    crowdLevel: "moderate",
    nextBusEta: 18,
    stops: ["Majestic", "Malleshwaram"],
    isBestRoute: false,
  },
  {
    id: "BUS-285M",
    route: "285-M",
    routeName: "Yelahanka → Majestic",
    lat: 13.08,
    lng: 77.585,
    eta: 12,
    delay: 4,
    ...
    crowdLevel: "full",
    nextBusEta: 30,
    stops: ["Yelahanka", "Hebbal", "Majestic"],
    isBestRoute: false,
  },
  {
    id: "BUS-2F",
    route: "2-F",
    routeName: "Banashankari → BTM Layout",
    lat: 12.92,
    lng: 77.58,
    eta: 5,
    delay: 2,
    ...
    crowdLevel: "crowded",
    nextBusEta: 20,
    stops: ["Banashankari", "Jayanagar", "BTM Layout", "Silk Board"],
    isBestRoute: true,
  },
  {
    id: "BUS-500D",
    route: "500-D",
    routeName: "Silk Board → Marathahalli",
    lat: 12.94,
    lng: 77.68,
    eta: 8,
    delay: 5,
    ...
    crowdLevel: "full",
    nextBusEta: 15,
    stops: ["Silk Board", "Koramangala", "Marathahalli", "Whitefield"],
    isBestRoute: false,
  },
];
...
export const leaderboard: LeaderboardEntry[] = [
  ...
  { rank: 8, name: "Ananya S", area: "Malleshwaram", points: 2650, co2Saved: 65 },
  { rank: 9, name: "Vikas Rao", area: "BTM Layout", points: 2420, co2Saved: 59 },
  { rank: 10, name: "Mohammed Ali", area: "Banashankari", points: 2110, co2Saved: 51 },
  { rank: 11, name: "Neha Gupta", area: "Marathahalli", points: 1980, co2Saved: 46 },
];
...
export interface MetroTrain {
  ...
  lng: number;
  nextStation: string;
  status: "Arriving" | "Departed" | "On Time";
}

export const metroStations: MetroStation[] = [
  { id: "ms1", name: "Mysore Road", lat: 12.9515, lng: 77.5303, line: "purple" },
  { id: "ms2", name: "Magadi Road", lat: 12.9754, lng: 77.5552, line: "purple" },
  { id: "ms3", name: "Majestic", lat: 12.9758, lng: 77.5708, line: "purple" },
  { id: "ms4", name: "MG Road", lat: 12.9734, lng: 77.608, line: "purple" },
  { id: "ms5", name: "Indiranagar", lat: 12.9785, lng: 77.6385, line: "purple" },
  { id: "ms6", name: "Baiyappanahalli", lat: 12.9904, lng: 77.6525, line: "purple" },
  { id: "ms7", name: "Yeshwanthpur", lat: 13.0232, lng: 77.5504, line: "green" },
  { id: "ms8", name: "Majestic (Green)", lat: 12.9758, lng: 77.5708, line: "green" },
  { id: "ms9", name: "Jayanagar", lat: 12.9298, lng: 77.5802, line: "green" },
  { id: "ms10", name: "Silk Institute", lat: 12.8687, lng: 77.535, line: "green" },
];
...
export const initialMetroTrains: MetroTrain[] = [
  {
    id: "mt1",
    line: "purple",
    lat: 12.965,
    lng: 77.545,
    nextStation: "Magadi Road",
    status: "On Time",
  },
  {
    id: "mt2",
  ...
  { id: "mt3", line: "green", lat: 13.0, lng: 77.56, nextStation: "Majestic", status: "On Time" },
  {
    id: "mt4",
    line: "green",
    lat: 12.95,
    lng: 77.575,
    nextStation: "Jayanagar",
    status: "Departed",
  },
];

export function moveMetroTrain(train: MetroTrain): MetroTrain {
  const jitterLat = (Math.random() - 0.5) * 0.0015;
  const jitterLng = (Math.random() - 0.5) * 0.0015;
  return {
    ...train,
    lat: train.lat + jitterLat,
    lng: train.lng + jitterLng,
  };
}
