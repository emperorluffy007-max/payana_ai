...
const areas = ['All', 'Majestic', 'Indiranagar', 'Koramangala', 'Hebbal', 'Jayanagar', 'Whitefield', 'Electronic City'];
...
function RoutesPage() {
  ...
  const filtered = allRoutes.filter(r => {
    const matchSearch = r.route.toLowerCase().includes(search.toLowerCase()) ||
